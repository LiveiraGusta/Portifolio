...
const projectsData = [
  ...
  },
  {
    ...
    alt: "Screenshot de duas telas do jogo Pedra Papel Tesoura",
    languages: ['TypeScript']
  },
  {
    name: "Modulo de Despesa",
    description: "Modulo de despesa para controle financeiro, com telas de cadastro de despesas, chamados do motorista, interação do controlador e historico",
    theme: "Fullstack",
    isProjectOnline: false,
    linkProject: "",
    isCodePublic: false,
  ...
  {
    name: "Starwars",
    description: "Sistema de avaliação com notas e comentarios, estudo utilizando a API Swapi",
    theme: "Fullstack",
    isProjectOnline: false,
    linkProject: "",
    isCodePublic: true,
  ...
  },
  {
    ...
    alt: "Screenshot de um terminal rodando um script",
    languages: ['Python']
  },
  {
...
const languagesListData = [
  ...
  },
  {
    name: 'Angular',
    size: "w-10 h-10",
    urlImage: "angular-logo.svg",
    alt: "Logo Angular"
  },
  {
    name: 'Node',
    size: "w-10 h-10",
    urlImage: "node-logo.svg",
    alt: "Logo Node"
  },
  {
    name: 'Javascript',
